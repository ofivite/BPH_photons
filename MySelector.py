...
#__aa = 0;    __bb = 50
MyFileNames = glob.glob("/afs/cern.ch/user/i/ivilkin/CMSSW_10_2_5/src/myAnalyzers/JPsiKsPAT/crab_projects_201?_Igorek_Bc_v1/crab_Bfinder_201?_Igorek_Bc_v1_*/results/*.root")
...
_fileOUT = '2017-18_Igorek_Bc_v1_' + str(len(MyFileNames)) + '_of_17BCDEF_18ABC.root'   #16 -> 1067; 17 -> 1271; 18 -> 1504
