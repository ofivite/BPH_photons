...
#__aa = 0;    __bb = 50
MyFileNames = glob.glob("/afs/cern.ch/user/i/ivilkin/CMSSW_10_2_5/src/myAnalyzers/JPsiKsPAT/crab_projects_2017_Igorek_Bc_v1/crab_Bfinder_2017_Igorek_Bc_v1_B/results/*.root")
...
_fileOUT = '2017_Igorek_Bc_v1_' + str(len(MyFileNames)) + '_of_1271_1.root'   #16 -> 1067; 17 -> 1271; 18 -> 1504
