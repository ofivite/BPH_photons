...
#__aa = 0;    __bb = 50
MyFileNames = glob.glob("/afs/cern.ch/user/i/ivilkin/CMSSW_10_2_5/src/myAnalyzers/JPsiKsPAT/crab_projects_Bs/crab_Bfinder_2017_Igorek_v1_*/results/*.root")
...
_fileOUT = '2017_Igorek_v1_Bs_' + str(len(MyFileNames)) + '_of_2017.root'   #16 -> 1067; 17 -> 1271; 18 -> 1504
...
'photon_noMC_DS2_PV', 'photon_withMC_DS2_PV', 'photon_flags_1', 
...
for evt in range(0, nEvt):
    ...
    for Bj in range(BInfo_size):
        ...
        photonV_withMC     = ROOT.TVector3(ch.PhotonDecayVtxX_2[ibs],  ch.PhotonDecayVtxY_2[ibs],  ch.PhotonDecayVtxZ_2[ibs]   )
        photonVE_withMC    = ROOT.TVector3( 0 if ch.PhotonDecayVtxXE_2[ibs] <= 0 else sqrt(ch.PhotonDecayVtxXE_2[ibs]),
...
###########################################################
 ...
 #       photon_cjp_cos2D_PV_1[0]        = DirectionCos2 ( photonV_c0_1 - PV, photon_cjp_P3_1 )
	...
	photon_withMC_E[0] = photon_withMC_P4.E()
        ...
        photon_withMC_cos2D_PV[0]        = DirectionCos2 ( photonV_withMC - PV, photon_withMC_P3 )
        photon_withMC_cos3D_PV[0]        = DirectionCos3 ( photonV_withMC - PV, photon_withMC_P3 )

        photon_withMC_DS2_PV[0] = DetachSignificance2(photonV_withMC - PV, PVE, photonVE_withMC)
