...
#__aa = 0;    __bb = 50
MyFileNames = glob.glob("/afs/cern.ch/user/i/ivilkin/CMSSW_10_2_5/src/myAnalyzers/JPsiKsPAT/crab_projects_C*8/crab_*/results/*.root")
...
_fileOUT = 'Igorek_v1_Chi_' + str(len(MyFileNames)) + '_of_18.root'   #16 -> 1067; 17 -> 1271; 18 -> 1504
